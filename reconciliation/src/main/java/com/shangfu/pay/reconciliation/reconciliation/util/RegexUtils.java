...
import static com.shangfu.pay.reconciliation.reconciliation.util.ConstUtils.*;
import static com.shangfu.pay.reconciliation.reconciliation.util.ConstUtils.REGEX_USERNAME;
...
//    }
    ...
    //isdata
    public static boolean isDate(CharSequence input) {
        return isMatch(REGEX_DATA, input);
    }
