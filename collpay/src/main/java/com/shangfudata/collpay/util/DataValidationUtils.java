...
public class DataValidationUtils {
    ...
    public String isMust(Map<String, String> map) {
        if (map.containsKey("down_sp_id")&&map.containsKey("down_mch_id")&&map.containsKey("out_trade_no")&&map.containsKey("body")
                ...
                &&map.containsKey("id_type")&&map.containsKey("id_no")&&map.containsKey("bank_mobile") &&map.containsKey("nonce_str"))
        { return "1"; }
        else
        { return "必填字段缺失，请检查"; }
    }
     ...
     */
    public void queryCollpayException(CollpayInfo easypayInfo, Map responseMap) {
        // 数据效验
        // 异常处理
        try {
