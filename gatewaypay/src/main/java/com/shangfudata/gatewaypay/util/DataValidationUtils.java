...
public class DataValidationUtils {
    ...
    public String isMust(Map<String, String> map) {
        if (map.containsKey("down_mch_id")&&map.containsKey("out_trade_no")&&map.containsKey("body")
                &&map.containsKey("total_fee")&&map.containsKey("notify_url")&&map.containsKey("card_type")&&map.containsKey("bank_code")
     ...
     * EasyPay 下游请求参数异常处理方法
     */
    public void queryGatepayException(GatewaypayInfo gatewaypayInfo, Map responseMap) {
        // 数据效验
        // 异常处理
        try {
            dataValidationUtils.nonceStrValid(gatewaypayInfo.getNonce_str());
